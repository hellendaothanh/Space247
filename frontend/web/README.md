...
1. **Bản đồ Bất động sản Tương tác (Leaflet)**: Hiển thị trực quan vị trí bất động sản, chuyển vùng tự động và tích hợp lớp phủ ranh giới vùng di chuyển (Isochrone polygon).
2. **Bộ sưu tập hình ảnh (PropertyGallery)**: Trình diễn ảnh dạng lưới kèm thanh trượt thu nhỏ (thumbnail strip) và bộ đếm ảnh.
3. **Bảng tính vay mua nhà (MortgageCalculator)**: Tích hợp ngay trên trang chi tiết, cho phép tính số tiền trả góp theo dư nợ giảm dần hoặc niên kim cố định.
4. **Cửa sổ Trợ lý AI (ChatAssistantWidget)**: Khung chat nổi hỗ trợ tương tác tự nhiên, trích xuất nhu cầu và gợi ý thẻ bài đăng trực quan.
5. **So sánh Bất động sản AI**: Cho phép đối chiếu từ 2 đến 3 căn nhà theo đơn giá trên một mét vuông, vị trí địa lý, tiện ích và tiềm năng tăng trưởng.
6. **Công cụ Định giá Thông minh (AVM Price Advisor)**: Hỗ trợ môi giới ước tính khoảng giá thị trường tối ưu khi đăng tin.
