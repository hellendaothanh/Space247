        ...
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="space-y-3">
              ...
              <a href={project.latitude && project.longitude ? `https://www.google.com/maps?q=${project.latitude},${project.longitude}` : undefined} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-sm text-slate-600 hover:text-blue-700">
            ...
            <div className="flex flex-col items-start gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-5 md:items-end">
              <div className="text-xs font-medium text-slate-500">Khoảng giá tham khảo</div>
              <div className="text-2xl font-bold text-blue-700">{formatPriceRange()}</div>
              ...
              <button type="button" onClick={() => setActiveTab("units")} className="inline-flex items-center gap-1.5 rounded-xl bg-blue-600 px-3 py-2 text-xs font-semibold text-white hover:bg-blue-700">
                <Download className="h-3.5 w-3.5" />Tải bảng giá & chính sách
              </button>
              <button
                type="button"
                onClick={handleShare}
          ...
          <div className="mt-8 grid grid-cols-2 gap-3 border-t border-slate-100 pt-6 sm:grid-cols-4">
            <div className="rounded-full bg-slate-50 px-4 py-3">
              <div className="text-[11px] text-slate-500">Tổng quy mô</div>
              <div className="mt-1 text-base font-bold text-slate-900">
                {project.total_units ? project.total_units.toLocaleString() : "Đang cập nhật"}
              </div>
            </div>
            <div className="rounded-full bg-slate-50 px-4 py-3">
              <div className="text-[11px] text-slate-500">Năm bàn giao</div>
              <div className="mt-1 text-base font-bold text-slate-900">
                {project.handover_year || "Đang cập nhật"}
              </div>
            </div>
            <div className="rounded-full bg-slate-50 px-4 py-3">
              <div className="text-[11px] text-slate-500">Pháp lý</div>
              <div className="mt-1 text-base font-bold text-slate-900">
                {project.legal_status || "Đang cập nhật"}
              </div>
            </div>
            <div className="rounded-full bg-slate-50 px-4 py-3">
              <div className="text-[11px] text-slate-500">Chủ đầu tư</div>
              <div className="mt-1 text-base font-bold text-slate-900">
        ...
        {activeTab === "overview" && (
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div className="space-y-6">
              <div className="sticky top-20 rounded-2xl border border-slate-200 bg-white p-6 shadow-xs">
                <p className="text-xs font-bold uppercase tracking-wider text-blue-600">Chuyên viên dự án</p>
                <div className="mt-4 flex items-center gap-3"><div className="grid h-12 w-12 place-items-center rounded-full bg-blue-100 font-bold text-blue-700">S247</div><div><p className="font-bold text-slate-900">Chuyên viên tư vấn dự án</p><a href="tel:19002467" className="text-sm font-semibold text-blue-700">1900 2467</a></div></div>
                <button type="button" onClick={() => setActiveTab("units")} className="mt-5 w-full rounded-xl bg-blue-600 px-4 py-3 text-sm font-bold text-white hover:bg-blue-700">Đăng ký nhận bảng giá & xem nhà mẫu</button>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs">
