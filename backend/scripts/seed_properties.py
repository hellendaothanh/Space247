...
SAMPLE_PROJECTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "video_url": "https://www.tiktok.com/@space247/video/1234567890123456789",
        "virtual_tour_url": "https://my.matterport.com/show/?m=SxQL3iGyoDo",
        "master_plan_url": "https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=1600&q=80",
        "legal_status": "Sổ hồng sở hữu lâu dài",
...
SAMPLE_PROPERTIES: list[dict[str, Any]] = [
    ...
    # --------------------------------------------------------------------------
    {
        ...
        "video_url": "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
        "virtual_tour_url": "https://www.youtube.com/shorts/dQw4w9WgXcQ",
    },
    {
    ...
    # --------------------------------------------------------------------------
    # CATEGORY C2: PHÒNG TRỌ SINH VIÊN & GÁC LỬNG (ROOM & MEZZANINE LISTINGS)
    # --------------------------------------------------------------------------
    {
        "title": "Phòng trọ gác lửng cao cấp mới xây Tạ Quang Bửu Bách Khoa",
        "description": "Cho thuê phòng trọ có gác lửng đúc cao 2m ngõ Tạ Quang Bửu Hai Bà Trưng. Gần cụm trường ĐH Bách Khoa, KTQD, Xây Dựng. Phòng mới 100%, trang bị điều hòa Inverter, nóng lạnh, bàn học, kệ bếp nấu ăn riêng. Cửa khóa vân tay, camera an ninh 24/7, không chung chủ.",
        "property_type": "apartment",
        "listing_type": "rent",
        "rental_type": "room",
        "rental_costs": {"electricity_billing": "state_rate", "deposit_months": 1, "service_fee_monthly": 50000},
        "rental_rules": {"curfew": False, "allow_pets": False, "private_bathroom": True, "has_mezzanine": True, "live_with_owner": False, "fingerprint_lock": True},
        "price": 3800000.0,
        "currency": "VND",
        "area_sqm": 25.0,
        "num_bedrooms": 1,
    ...
    {
        "title": "Phòng trọ studio gác lửng thoáng mát Làng Đại Học Thủ Đức",
        "description": "Phòng trọ có gác lửng đúc kiên cố gần KTX ĐHQG TP.HCM. Cửa sổ lớn đón gió tự nhiên, có ban công phơi đồ riêng, bếp từ và tủ lạnh mini. Tự do giờ giấc không chung chủ, bảo vệ 24/24, thang máy di chuyển tiện lợi.",
        "property_type": "apartment",
        "listing_type": "rent",
        "rental_type": "room",
        "rental_costs": {"electricity_billing": "state_rate", "deposit_months": 1, "service_fee_monthly": 60000},
        "rental_rules": {"curfew": False, "allow_pets": True, "private_bathroom": True, "has_mezzanine": True, "live_with_owner": False, "has_elevator": True},
        "price": 3200000.0,
        "currency": "VND",
        "area_sqm": 28.0,
        "num_bedrooms": 1,
        "num_bathrooms": 1,
        "address": "Đường Quảng Trường Sáng Tạo, Phường Đông Hòa",
    ...
    {
        "title": "Phòng trọ có gác lửng full đồ phố Dịch Vọng Hậu Cầu Giấy",
        "description": "Phòng trọ gác cao không đụng đầu phố Dịch Vọng Hậu Cầu Giấy. Gần ĐH Quốc Gia, ĐH Sư Phạm, HV Báo Chí. Trang bị sẵn giường đệm, tủ quần áo âm tường, điều hòa Daikin, máy giặt dùng chung sân thượng, wifi cáp quang tốc độ cao.",
        "property_type": "apartment",
        "listing_type": "rent",
        "rental_type": "room",
        "rental_costs": {"electricity_billing": "state_rate", "deposit_months": 1, "service_fee_monthly": 80000},
        "rental_rules": {"curfew": False, "allow_pets": False, "private_bathroom": True, "has_mezzanine": True, "live_with_owner": False, "fingerprint_lock": True},
        "price": 4200000.0,
        "currency": "VND",
        "area_sqm": 30.0,
        "num_bedrooms": 1,
        "num_bathrooms": 1,
        "address": "Phố Dịch Vọng Hậu, Phường Dịch Vọng Hậu",
        "ward": "Phường Dịch Vọng Hậu",
        "district": "Quận Cầu Giấy",
        "city": "Thành phố Hà Nội",
        "latitude": 21.0378,
    ...
    {
        "title": "Phòng trọ gác lửng đúc ban công riêng D2 Nguyễn Gia Trí Bình Thạnh",
        "description": "Phòng trọ gác lửng ban công đường D2 (Nguyễn Gia Trí) Bình Thạnh. Khu vực sầm uất tập trung nhiều quán ăn sinh viên, gần ĐH HUTECH, Ngoại Thương cơ sở 2, GTVT. Phòng sạch sẽ lát gạch men, vệ sinh khép kín có bồn rửa mặt và vòi sen tắm đứng.",
        "property_type": "apartment",
        "listing_type": "rent",
        "rental_type": "room",
        "rental_costs": {"electricity_billing": "state_rate", "deposit_months": 1, "service_fee_monthly": 70000},
        "rental_rules": {"curfew": False, "allow_pets": True, "private_bathroom": True, "has_mezzanine": True, "live_with_owner": False},
        "price": 4000000.0,
        "currency": "VND",
        "area_sqm": 26.0,
        "num_bedrooms": 1,
        "num_bathrooms": 1,
        "address": "Đường Nguyễn Gia Trí, Phường 25",
        "ward": "Phường 25",
        "district": "Quận Bình Thạnh",
        "city": "Thành phố Hồ Chí Minh",
        "latitude": 10.8035,
    ...
    {
        "title": "Phòng trọ sinh viên tiện nghi gác cao gần ĐH Bách Khoa Đà Nẵng",
        "description": "Cho thuê phòng trọ sinh viên mới xây đường Ngô Sĩ Liên quận Liên Chiểu Đà Nẵng. Cách cổng trường ĐH Bách Khoa và ĐH Sư Phạm 300m. Có gác lửng đổ bê tông, bếp nấu ăn ốp đá hoa cương, chỗ để xe rộng rãi miễn phí, camera giám sát 24/24.",
        "property_type": "apartment",
        "listing_type": "rent",
        "rental_type": "room",
        "rental_costs": {"electricity_billing": "state_rate", "deposit_months": 1, "service_fee_monthly": 40000},
        "rental_rules": {"curfew": False, "allow_pets": False, "private_bathroom": True, "has_mezzanine": True, "live_with_owner": False},
        "price": 2500000.0,
        "currency": "VND",
        "area_sqm": 22.0,
        "num_bedrooms": 1,
        "num_bathrooms": 1,
        "address": "Đường Ngô Sĩ Liên, Phường Hòa Khánh Bắc",
    ...
    {
        "title": "Phòng trọ duplex gác lửng hiện đại ngõ 332 Nguyễn Trãi Thanh Xuân",
        "description": "Phòng trọ phong cách duplex có gác lửng đứng thẳng người phố Nguyễn Trãi quận Thanh Xuân. Đi bộ 5 phút ra ĐH Hà Nội, ĐH Khoa Học Tự Nhiên. Full nội thất gồm điều hòa, tủ lạnh, máy hút mùi, bàn ghế làm việc. Nhà xe vân tay an ninh tuyệt đối.",
        "property_type": "apartment",
        "listing_type": "rent",
        "rental_type": "room",
        "rental_costs": {"electricity_billing": "state_rate", "deposit_months": 1, "service_fee_monthly": 80000},
        ...
        "num_bedrooms": 1,
        "num_bathrooms": 1,
        "address": "332 Nguyễn Trãi, Phường Thanh Xuân Trung",
